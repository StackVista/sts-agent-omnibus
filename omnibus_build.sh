...
git --git-dir=/var/cache/omnibus/cache/git_cache/opt/stackstate-agent tag -d `git --git-dir=/var/cache/omnibus/cache/git_cache/opt/stackstate-agent tag -l | grep datadog-agent`
git --git-dir=/var/cache/omnibus/cache/git_cache/opt/stackstate-agent tag -d `git --git-dir=/var/cache/omnibus/cache/git_cache/opt/stackstate-agent tag -l | grep datadog-gohai`
git --git-dir=/var/cache/omnibus/cache/git_cache/opt/stackstate-agent tag -d `git --git-dir=/var/cache/omnibus/cache/git_cache/opt/stackstate-agent tag -l | grep datadog-metro`
